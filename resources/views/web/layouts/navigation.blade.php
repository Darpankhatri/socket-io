...
<nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
    <!-- Brand -->
    <a style="cursor: pointer;" title="Messenger" class="d-none d-xl-block mb-6">
    ...
    <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3"
        ...
        <li class="nav-item">
            <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="#tab-content-chats" title="Chats"
                ...
                <div class="icon icon-xl icon-badged">
                    <i class="fal fa-comment-alt fa-lg"></i>
        ...
        <!-- Profile -->
        <li class="nav-item d-none d-xl-block">
            <a style="cursor: pointer;" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal"
                            ...
                            <a href="chat-group.html" class="card border-0 text-reset">
                                <div class="card-body">
                                    <div class="row gx-5">
                                        <div class="col-auto">
                                            <div class="avatar avatar-online">
                                                <img src="{{ asset('chat/img/avatars/7.jpg') }}" alt="#"
                                                    class="avatar-img">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row align-items-center gx-4">
                                        ...
                                        <div class="col-auto">
                                            <div class="avatar-group">
                                                <div class="avatar avatar-xs">
                                                    <img src="{{ asset('chat/img/avatars/12.jpg') }}" alt="#"
                                                        class="avatar-img">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="{{ asset('chat/img/avatars/11.jpg') }}" alt="#"
                                                        class="avatar-img">
                                                </div>

                                                <div class="avatar avatar-xs">
                                                    <img src="{{ asset('chat/img/avatars/9.jpg') }}" alt="#"
                                                        class="avatar-img">
                                                </div>
                            ...
                            <a href="chat-direct.html" class="card border-0 text-reset">
                                <div class="card-body">
                                    <div class="row gx-5">
                                        <div class="col-auto">
                                            <div class="avatar avatar-online">
                                                <img src="{{ asset('chat/img/avatars/6.jpg') }}" alt="#"
                                                    class="avatar-img">
                                            </div>
                                        </div>
                            ...
                            <a href="chat-empty.html" class="card border-0 text-reset">
                                <div class="card-body">
                                    <div class="row gx-5">
                                        <div class="col-auto">
                                            <div class="avatar avatar-online">
                                                <img src="{{ asset('chat/img/avatars/8.jpg') }}" alt="#"
                                                    class="avatar-img">
                                            </div>
                                        </div>
                            ...
                            <a href="chat-direct.html" class="card border-0 text-reset">
                                <div class="card-body">
                                    <div class="row gx-5">
                                        <div class="col-auto">
                                            <div class="avatar">
                                                <img src="{{ asset('chat/img/avatars/4.jpg') }}" alt="#"
                                                    class="avatar-img">
                                            </div>
                                        </div>
                            ...
                            <a href="chat-direct.html" class="card border-0 text-reset">
                                <div class="card-body">
                                    <div class="row gx-5">
                                        <div class="col-auto">
                                            <div class="avatar avatar-online">
                                                <img src="{{ asset('chat/img/avatars/5.jpg') }}" alt="#"
                                                    class="avatar-img">
                                            </div>
                                        </div>
                                ...
                                <div class="row align-items-center gx-5">
                                    <div class="col-auto text-primary">
                                        <svg version="1.1" width="46px" height="46px" fill="currentColor"
                                            ...
                                            y="0px" viewBox="0 0 46 46" enable-background="new 0 0 46 46"
                                            xml:space="preserve">
                                            <polygon opacity="0.7" points="45,11 36,11 35.5,1 " />
                                            <polygon points="35.5,1 25.4,14.1 39,21 " />
                                            <polygon opacity="0.4" points="17,9.8 39,21 17,26 " />
                                            ...
                                            <div id="accordion-storage-body-1" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <input type="range" class="form-range" min="1"
                                                        max="4" step="1" id="custom-range-1">
                                                </div>
                                            </div>
                                        </div>
